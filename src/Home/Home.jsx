      ...
      <section className="flex justify-between gap-3 bg-slate-200 text-center text text-black">
        <div className="w-1/5 h-[100vh] overflow-y-scroll">
          <div className="flex text-center gap-5 mt-3 justify-center">
            ...
            <span className="bg-blue-400  w-6 h-6  text-white rounded-full mt-2">{fTodo.length}</span>
          </div>
        ...
        <div className="w-1/5 h-[100vh] overflow-y-scroll">
          <div className="flex text-center gap-5 mt-3 justify-center">
            ...
            <span className="bg-blue-400  w-6 h-6 text-white rounded-full mt-2">{fDoing.length}</span>
          </div>
        ...
        <div className="w-1/5 h-[100vh] overflow-y-scroll">
          <div className="flex text-center gap-5 mt-3 justify-center">
            ...
            <span className="bg-blue-400  w-6 h-6 text-white rounded-full mt-2">{fComplete.length}</span>
          </div>
        ...
        <div className="w-1/5 h-[100vh]  overflow-y-scroll">
          <div className="flex text-center gap-5 mt-3 justify-center">
            ...
            <span className="bg-blue-400  w-6 h-6  text-white rounded-full mt-2">{fInComplete.length}</span>
          </div>
        ...
        <div className="w-1/5 h-[100vh] overflow-y-scroll">
          <div className="flex gap-5 text-center mt-3 justify-center">
            ...
            <span className="bg-blue-400 w-6 h-6  text-white rounded-full mt-2">{fUnderReview.length}</span>
          </div>
